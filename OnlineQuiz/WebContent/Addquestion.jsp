...
<h1>ADD QUESTION : </h1>
<form action="Profques" method="post">

<div class="a" style="color:white;">
Question:<input  style="padding:4px;  border-radius: 4px; width:60%;"type="text"  name="1" style="width: 500px;"><br><br><br>
Option 1         <input  style="padding:4px;  border-radius: 4px;" type="text"  name="o1" ><br><br>
Option 2         <input  style="padding:4px;  border-radius: 4px;" type="text"  name="o2" ><br><br>
Option 3         <input  style="padding:4px;  border-radius: 4px;" type="text"  name="o3" ><br><br>
Option 4         <input style="padding:4px;  border-radius: 4px; " type="text"  name="o4" ><br><br><br>
Answer : <input  style="padding:4px;  border-radius: 4px;" type="text" name="Cort"><br><br>
...
<input  style="background-color:orange;
  ...
  margin-top: 6px;
  margin-bottom: 16px;
  cursor:pointer;"type="submit" value="submit" name="submit" formaction="AddServlet">
  </form>
</div>
</div>
