...
var pwd2=document.getElementById("cnpwd").value;
if(pwd2!=pwd1 )
 {
 alert("Enter same password for both feilds ");
 return false;
 }
else
 {
...
<form  name="Change_password" action="PasswdServlet" method="post" onsubmit=" return validate();">

 <div class="container">
<div class="row">


<div style="background-color:#34495e; border:1px solid;padding:8px;height:600px;
  border-radius: 6px;
  margin-top: 8px;
  margin-left: 250px;margin-right:250px;">
<font style="color:white; " size="7">Change Password</font>
<br>
<br>
<br>
...
<table>
<tr>
<td style="color:white; ">RegisterId</td>
<td><input style="padding:4px;  border-radius: 4px;"  type="text" name="Regid" required ></td>
</tr>
<br>
<tr>
<td style="color:white; ">Current Password</td>
<td><input style="padding:4px;  border-radius: 4px;" type="text" name="cpwd" required ></td>
</tr>

<tr>
<td style="color:white; ">New Password       </td>
<td><input style="padding:4px;  border-radius: 4px;" type="text" name="npwd" id="npwd" pattern="(?=.*\d)(?=.*[a-z])(?=.*[A-Z]).{8,}" 
...
<tr>
<td style="color:white; ">Confirm New Password     </td> 
<td><input style="padding:4px;  border-radius: 4px;" type="password" name="cnpwd" id="cnpwd" pattern="(?=.*\d)(?=.*[a-z])(?=.*[A-Z]).{8,}" 
title="Must contain at least one number and one uppercase and lowercase letter, and at least 8 or more characters" required></td>
</tr>
...
<td><input  style="background-color:orange;
  ...
  margin-top: 6px;
  margin-bottom: 16px;
  cursor:pointer;" type="submit"  value="Submit" ></td>
</tr>
</table> 
