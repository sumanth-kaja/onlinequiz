  ...
  <div class="row">
    <div class="col-md-3">
      <div class="cardholder">
        <div class="card">
        <a href="stu.jsp"><img src="c.jpg"/></a>
		<p class="desc">Online Quiz</p>
        </div>
      </div>
    </div>
    ...
    <div class="col-md-3">
      <div class="cardholder">
        <div class="card">
           <a href="stu.jsp"><img src="sql.jpg" /></a>
          <p class="desc">Online Quiz</p>
        </div>
      </div>
    </div>
    ...
    <div class="col-md-3">
      <div class="cardholder">
        <div class="card">
          <a href="stu.jsp"><img src="python.jpg"/></a>
		<p class="desc">Online Quiz</p>
        </div>
      </div>
    </div>
    ...
    <div class="col-md-3">
      <div class="cardholder">
        <div class="card">
          <a href="stu.jsp"><img src="java.jpg" /></a>
		<p class="desc">Online Quiz</p>
        </div>
      </div>
    </div>
    ...
    <div class="col-md-3">
      <div class="cardholder">
        <div class="card">
          <a href="stu.jsp"><img src="css.png"/></a>
		<p class="desc">Online Quiz</p>
        </div>
      </div>
    </div>
    ...
    <div class="col-md-3">
      <div class="cardholder">
        <div class="card">
           <a href="stu.jsp"><img src="php.png" /></a>
          <p class="desc">Online Quiz</p>
        </div>
      </div>
    </div>
    ...
    <div class="col-md-3">
      <div class="cardholder">
        <div class="card">
          <a href="stu.jsp"><img src="c++.jfif"/></a>
		<p class="desc">Online Quiz</p>
        </div>
      </div>
    </div>
    ...
    <div class="col-md-3">
      <div class="cardholder">
        <div class="card">
          <a href="stu.jsp"><img src="R.png" /></a>
		<p class="desc">Online Quiz</p>
        </div>
      </div>
    </div>
