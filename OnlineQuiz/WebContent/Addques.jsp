...
Option 1         <input  style="padding:4px;  border-radius: 4px;" type="text"  name="Q1" ><br><br>
Option 2         <input  style="padding:4px;  border-radius: 4px;" type="text"  name="Q2" ><br><br>
Option 3         <input  style="padding:4px;  border-radius: 4px;" type="text"  name="Q3" ><br><br>
Option 4         <input style="padding:4px;  border-radius: 4px; " type="text"  name="Q4" ><br><br><br>
...
<input  style="background-color:orange;
  ...
  margin-top: 6px;
  margin-bottom: 16px;
  cursor:pointer;"type="submit" value="submit" name="submit" formaction="deleteservlet1">
  </form>
</div>
</div>
